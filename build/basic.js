...
bb = [1, 2, 3]; // error TS2322: Type 'number' is not assignable to type 'string'.
/**
...
/* error TS2741: Property 'streetName' is missing in type '{ houseNumber: number; }' but required in type '{ houseNumber: number; streetName: string; }'.

97  cc = {
    ~~

  basic.ts:81:33
    81  let cc: { houseNumber: number; streetName: string };
                                       ~~~~~~~~~~
    'streetName' is declared here. */
cc = {
    houseNumber: 33
};
/**
